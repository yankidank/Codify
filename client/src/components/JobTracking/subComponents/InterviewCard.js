  ...
  return (
      <div className="card card-padded card-position">
        <div className="interviewInputs">
          ...
          <div className="input-field ">
            <Cleave options={{time: true, timePattern: ['h', 'm']}} className="col s4 m4 l4" placeholder="10:30" onChange={(event) => handleInputChange(event, index, _id)} name="time" value={time}/>
          </div>
